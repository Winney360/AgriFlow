...
export const SignupPage = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#f7f8f7] px-2 py-4 sm:px-4 sm:py-6">
      <div className="w-full max-w-[95vw] sm:max-w-sm md:max-w-md lg:max-w-lg rounded-lg border border-[#d8ddda] bg-white shadow-sm mx-auto">
        <form onSubmit={onSubmit} className="space-y-4 px-2 py-5 sm:px-6 sm:py-6">
          <div>
            <h1 className="text-2xl sm:text-3xl font-black text-[#1f1f1f]">Create your AgriFlow account.</h1>
            <p className="mt-2 text-xs sm:text-sm text-[#666]">Sign up with your details to start buying or selling locally.</p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row items-center h-11 rounded-lg border border-[#d0d6d2] bg-white px-2 sm:px-3 gap-2 sm:gap-0">
